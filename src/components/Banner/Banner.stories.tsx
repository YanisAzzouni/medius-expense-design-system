...
export const Types: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 480 }}>
      <Banner variant="information" title="Information" showIcon>
...
export const Dismissible: Story = {
  render: () => {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 480 }}>
        {shown.info && (
          <Banner variant="information" title="Policy update" dismissible onDismiss={() => dismiss("info")}>
            The travel expense policy has been updated. Review the changes.
          </Banner>
        )}
        {shown.warning && (
          <Banner variant="warning" dismissible onDismiss={() => dismiss("warning")}>
            Your session will expire in 5 minutes.
          </Banner>
        )}
        {shown.error && (
          <Banner variant="error" title="Payment failed" dismissible onDismiss={() => dismiss("error")}>
            The bank rejected the transfer. Contact finance.
          </Banner>
        )}
        {shown.success && (
          <Banner variant="success" dismissible onDismiss={() => dismiss("success")}>
...
export const NoIcon: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 480 }}>
      <Banner variant="information" showIcon={false}>
        Expense category is inferred from the supplier name.
      </Banner>
      <Banner variant="success" title="Saved" showIcon={false}>
...
export const ContentVariants: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 480 }}>
      <Banner variant="information" title="Title only — no body text" />
      <Banner variant="warning">
        Body text only — no title above it.
      </Banner>
      <Banner variant="error" title="Title and body" >
